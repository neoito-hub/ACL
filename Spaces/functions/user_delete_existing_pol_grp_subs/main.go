package user_delete_existing_pol_grp_subs
...
func Handler(payload common_services.HandlerPayload) common_services.HandlerResponse {
	...
	// 	Err: false,
	// 	Msg: "User policy group subscription removed successfully!",
	// })

	handlerResp = common_services.BuildResponse(false, "User policy group subscription removed successfully!", Response{
		Err: false,
		Msg: "User policy group subscription removed successfully!",
	}, http.StatusOK)
	return handlerResp
