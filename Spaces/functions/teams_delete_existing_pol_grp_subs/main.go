package teams_delete_existing_pol_grp_subs
...
func Handler(payload common_services.HandlerPayload) common_services.HandlerResponse {
	...
	// 	Err: false,
	// 	Msg: "Team policy group subscription removed successfully!",
	// })

	handlerResp = common_services.BuildResponse(false, "Team policy group subscription removed successfully!", Response{
		Err: false,
		Msg: "Team policy group subscription removed successfully!",
	}, http.StatusOK)
	return handlerResp
