...
const RolesUserList = (props) => {
  ...
  return (
    <div
      ref={refsById[item.role_id]}
      style={{
        height:
          accordianID === item.role_id
                ...
                >
                  ...
                  <td className="p-3">
                    <div className="flex flex-wrap items-center">
                      ...
                      {user?.teams?.length > chipsToDisplay && (
