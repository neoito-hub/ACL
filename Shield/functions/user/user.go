...
import (
	...
	"github.com/neoito-hub/ACL-Block/SHIELD/functions/appreg"
	"github.com/neoito-hub/ACL-Block/SHIELD/functions/auth"
	"github.com/neoito-hub/ACL-Block/SHIELD/functions/general"
	"github.com/neoito-hub/ACL-Block/SHIELD/functions/mailer"
	"github.com/neoito-hub/ACL-Block/SHIELD/functions/pghandling"
	"github.com/neoito-hub/ACL-Block/SHIELD/functions/token"
...
func VerfiyUserEmail(c *gin.Context) {
	...
	// Print the value of ResponseType
	fmt.Println("ResponseType:", urlParams.ResponseType)
	fmt.Println("CientId:", urlParams.ClientId)
